    ...
    body = (
      <div className={classes.paper}>
        ...
        <div className={classes.infoContainer}>
          ...
          <div className={classes.chipContainer}>{['Business', 'Entertainment', 'General', 'Health', 'Science', 'Sports', 'Technology'].map((category, index) => <Chip label={category} color="primary" className={classes.chip} key={index} />)}</div>
        </div>
        ...
        <div className={classes.infoContainer}>
          ...
          <div className={classes.chipContainer}>{['Donald Trump', 'Bitcoin', 'PlayStation 5', 'Smartphones'].map((term, index) => <Chip label={term} color="primary" key={index} className={classes.chip} />)}<Chip label="...and more" className={classes.chip} /></div>
        </div>
        ...
        <div className={classes.infoContainer}>
          ...
          <div className={classes.chipContainer}>{['CNN', 'Wired', 'BBC News', 'Time', 'IGN', 'Buzzfeed', 'ABC News'].map((source, index) => <Chip label={source} color="primary" className={classes.chip} key={index} />)}<Chip label="...and more" className={classes.chip} /></div>
        </div>
